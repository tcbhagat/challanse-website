...
The token needs Zone Read, DNS Edit, and Dynamic URL Redirects Edit for `constrovet.com`, plus Zone Edit if the zone has not yet been added. Select only the Constrovet account and domain when creating it.
